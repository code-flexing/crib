  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#ffffff_0%,#f5f7f2_100%)] pb-24 md:pb-8">
      ...
      <section className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-8">
        ...
        {status === "pending" && <div className="mt-6 rounded-[4px] border border-black/10 bg-white p-4 text-sm text-black/65">Your profile is under review. You can update it after a decision.</div>}
